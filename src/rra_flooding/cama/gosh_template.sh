...
EXP="example_exp"                       # experiment name (output directory name)
...
#============================
#*** 1c. simulation time
YSTA="1900"                                   # start year ( from YSTA / Jan  1st _ 00:00)
YEND="2525"                                  # end   year (until YEND / Dec 31st _ 24:00)
...
CROFDIR="${BASE}/inp/NorESM2-MM_ssp245_r1i1p1f1_2095-2100/runoff"     # runoff directory
...
CVARSOUT="rivout,fldfrc,fldare,flddph" # list output variable (comma separated)
